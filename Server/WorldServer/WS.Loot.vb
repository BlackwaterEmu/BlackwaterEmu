...
Public Module WS_Loot
        ...
        If LootTable.ContainsKey(GUID) Then
            ...
            Else
                ...
                ElseIf GuidIsGameObject(GUID) Then
                    ...
                    'response.AddInt8(0)
                    Dim UpdateData As New UpdateClass
                    UpdateData.SetUpdateFlag(EGameObjectFields.GAMEOBJECT_BYTES_1, 0, WORLD_GAMEOBJECTs(GUID).State)
    ...
    Public Function GenerateLoot(ByRef Character As CharacterObject, ByVal GUID As ULong, ByVal LootType As LootType) As Boolean
#If DEBUG Then
...
#End If
    ...
    Public Sub On_CMSG_OPT_OUT_OF_LOOT(ByRef packet As PacketClass, ByRef Client As ClientClass)
        packet.GetInt16()
        Dim State As LootState = packet.GetUInt32
