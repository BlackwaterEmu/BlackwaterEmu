...
#Region "Global.Config"
    ...
    Public Class XMLConfigFile
        ...
        <XmlElement(ElementName:="SQLPass")> Public SQLPass As String = "root"
        ...
        <XmlElement(ElementName:="SQLDBName")> Public SQLDBName As String = "blackwater"
    ...
    Public Sub LoadConfig()
        Try
            ...
            If System.IO.File.Exists(FileName) = False Then
                ...
                Console.WriteLine("Please copy the ini files into the same directory as the Blackwater exe files.")
...
#End If
                ...
                For varList = LBound(CommandList) To UBound(CommandList)
                    ...
                    If CommandList(varList).Length > 0 Then
                        ...
                        Select Case cmds(0).ToLower
						    ...
						    Case "server.info"
                                Console.writeline("Work in Progress 3.0.9 based emulator.           ")
                                Console.WriteLine("    ____  __           __                  __               ______ ")
                                Console.WriteLine("   / __ )/ /___ ______/ /___      ______ _/ /____  _____   / ____/___ ___  __  __")
                                Console.WriteLine("  / __  / / __ `/ ___/ //_/ | /| / / __ `/ __/ _ \/ ___/  / __/ / __ `__ \/ / / /")
                                Console.WriteLine(" / /_/ / / /_/ / /__/ ,<  | |/ |/ / /_/ / /_/  __/ /     / /___/ / / / / / /_/ / ")
                                Console.WriteLine("/_____/_/\__,_/\___/_/|_| |__/|__/\__,_/\__/\___/_/     /_____/_/ /_/ /_/\__,_/  ")
                            ...
                            Case "help", "/help"
                                ...
                                Console.WriteLine("'Blackwater.WorldServer' Command list:")
                                Console.ForegroundColor = System.ConsoleColor.White
                                Console.WriteLine("---------------------------------")
                                Console.WriteLine("")
                                Console.WriteLine("")
                                Console.WriteLine("'help' or '/help' - Brings up the 'Blackwater.WorldServer' Command list (this).")
                                Console.WriteLine("")
                                ...
                                Console.WriteLine("")
                                Console.WriteLine("'quit' or 'shutdown' or 'off' or 'kill' or 'exit' - Shutsdown 'Blackwater.WorldServer'.")
                                Console.WriteLine("")
                            ...
                            Case Else
                                Console.ForegroundColor = System.ConsoleColor.DarkRed
                                Console.WriteLine("Error! Cannot find specified command. Please type 'help' for information on 'Blackwater.WorldServer' console commands.")
                                Console.ForegroundColor = System.ConsoleColor.Gray
                        End Select
    ...
    Private Sub GenericExceptionHandler(ByVal sender As Object, ByVal e As UnhandledExceptionEventArgs)
        ...
        Log.WriteLine(LogType.FAILED, "Unexpected error has occured. An 'Error-yyyy-mmm-d-h-mm.log' file has been created. Please post the file in the BUG SECTION at ac-web.org on our thread!")
