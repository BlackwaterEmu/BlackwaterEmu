...
Public Module WS_Handlers
    ...
    Public Sub IntializePacketHandlers()
        ...
        PacketHandlers(OPCODES.CMSG_SOCKET_GEMS) = CType(AddressOf On_CMSG_SOCKET_GEMS, HandlePacket)
        ...
        PacketHandlers(OPCODES.CMSG_CANCEL_TEMP_ENCHANTMENT) = CType(AddressOf On_CMSG_CANCEL_TEMP_ENCHANTMENT, HandlePacket)
